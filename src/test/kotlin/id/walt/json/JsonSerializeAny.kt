package id.walt.services.data//import kotlinx.serialization.*
...
//
//        val encoded = Klaxon().toJsonString(mapData)
//        println(encoded)
//
//        val decoded = Klaxon().parse<MySerializableData>(encoded)
//        println(decoded)
//
//        // require(mapData == decoded)
//
//        val mapStringAny = MapStringAny(map)
//        val encoded2 = Klaxon().toJsonString(mapStringAny)
//        println(encoded2)
//
//        val decoded2 = Klaxon().parse<MapStringAny>(encoded2)
//        println(decoded2)
//
