...
class SDJwtServiceTest: AnnotationSpec() {
    ...
    fun testNestedSDClaims() {
        ...
        val parsedUndisclosed_nested_nested = sd_jwt_nested_nested.undisclosedPayload
        ...
        val parsedUndisclosed_nested_mixed = sd_jwt_nested_mixed.undisclosedPayload
        ...
        presentedJwt.disclosures.map { SDisclosure.parse(it).key } shouldContainAll setOf("objectProp", "nestedObj")
        presentedJwt.disclosures.map { SDisclosure.parse(it).key } shouldNotContain "nestedObjProp1"
