...
internal class JwtServiceTest {
    ...
    companion object {
        ...
        fun generateJwtNoPayloadSource(): Stream<Arguments> = Stream.of(
            arguments(
                JwtTestInput(KeyAlgorithm.ECDSA_Secp256k1, "ES256K", "https://walt.id"),
                true
            ),
            arguments(
                JwtTestInput(KeyAlgorithm.EdDSA_Ed25519, "EdDSA", "https://walt.id"),
                true
            ),
            arguments(
                JwtTestInput(KeyAlgorithm.RSA, "RS256", "https://walt.id"),
                true
            ),
        )
        ...
        fun generateJwtCustomPayloadSource(): Stream<Arguments> = Stream.of(
            arguments(
                JwtTestInput(KeyAlgorithm.ECDSA_Secp256k1, "ES256K", "https://self-issued.me"),
                true
            ),
            arguments(
                JwtTestInput(KeyAlgorithm.EdDSA_Ed25519, "EdDSA", "https://self-issued.me"),
                true
            ),
            arguments(
                JwtTestInput(KeyAlgorithm.RSA, "RS256", "https://self-issued.me"),
                true
            ),
        )
    }
