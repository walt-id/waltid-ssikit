...
object DidService {
    ...
    //region did-resolve
    fun resolve(did: String, options: DidOptions? = null): Did = resolve(DidUrl.from(did))
    fun resolve(didUrl: DidUrl, options: DidOptions? = null): Did = didResolverFactory.create(didUrl).resolve(didUrl)
    //endregion
