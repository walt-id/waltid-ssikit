...
object StatusList2021Service {
    ...
    fun checkRevoked(credentialStatus: StatusList2021EntryCredentialStatus): RevocationStatus = let {
        ...
        RevocationStatus(isRevoked = verifyBitStringStatus(credentialIndex, credentialSubject.encodedList))
    }
