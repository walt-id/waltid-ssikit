...
class VcTemplateService : WaltIdService() {
    override val implementation get() = serviceImplementation<VcTemplateService>()
    private val log = KotlinLogging.logger {}

    companion object : ServiceProvider {
        private val implementation = VcTemplateService()
